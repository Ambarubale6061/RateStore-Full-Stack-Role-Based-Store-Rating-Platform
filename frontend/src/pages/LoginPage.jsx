...
import { Loader2, LogIn, ShieldCheck, Mail, Lock } from "lucide-react";
...
const LoginPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-blue-50 dark:bg-[#0a0a0a] px-4 font-sans text-slate-900 dark:text-white transition-colors duration-300">
      {/* Background glows */}
      ...
      <motion.div
        ...
        className="w-full max-w-[420px] z-10 space-y-8"
      >
        {/* Header */}
        ...
        <div className="relative group">
          <div className="absolute -inset-0.5 rounded-3xl blur opacity-20 dark:opacity-25 group-hover:opacity-30 dark:group-hover:opacity-45 transition duration-1000 bg-gradient-to-r from-blue-500/60 to-indigo-500/60" />
          ...
          <div className="relative bg-white dark:bg-[#0d1117]/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            >
              <div className="space-y-5">
                ...
                <div className="relative group/field space-y-1.5">
                  ...
                  <FormField
                    ...
                    className="pl-10 pr-4 py-3 bg-slate-50 dark:bg-[#0a0a0a] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-gray-600 rounded-xl w-full focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-150 text-base outline-none"
                    required
                  />
                </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="relative overflow-hidden w-full py-4 px-4 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed group/btn shadow-[0_4px_14px_0_rgba(0,118,255,0.4)]"
              >
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="pt-6 flex flex-col items-center gap-1 opacity-60 hover:opacity-100 transition-opacity duration-500">
            <div className="h-[1px] w-12 bg-gradient-to-r from-transparent via-slate-400 dark:via-gray-500 to-transparent mb-2" />
